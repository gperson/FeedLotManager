USE feedlot;
INSERT INTO `FARM` VALUES (1,'Holz Bros.');
INSERT INTO `USERS` VALUES (1,'JHolz','James','Holz','jtholzbeef@gmail.com','$2a$10$EblZqNptyYvcLm/VwDCVAuBjzZOI7khzdyGPBr08PpIi0na624b8.',1,1),(2,'HHolz','Howard','Holz','howard@gmail.com','$2a$10$EblZqNptyYvcLm/VwDCVAuBjzZOI7khzdyGPBr08PpIi0na624b8.',1,1);
INSERT INTO `ROLES` VALUES ('HHolz','Default'),('JHolz','Admin'),('JHolz','Default');
INSERT INTO `FEED_TYPES` VALUES (1,1,'Corn',50,1),(2,1,'Hay',90,1);
INSERT INTO `SUPPLIER` VALUES (1,'Bob\'s Big Ass Cows','Kearney, NE',1),(2,'The Cow Locker','Rockford, IL',1);
...
INSERT INTO `LOCALE` VALUES (1,1,'SE Lot',1),(2,1,'NE Back Lot',1),(3,1,'Small Pasture',1);
INSERT INTO `PACKER` VALUES (1,'Tyson','Fort Dodge, IA',1),(2,'Scuba Steve Packers Inc.','Miami, FL',1);