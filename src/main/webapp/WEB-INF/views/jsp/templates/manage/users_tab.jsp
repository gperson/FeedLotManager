...
<div id="user_popup" class="popup"style="display:none;">
	<form name="userForm" role="form">
		<div class="form-group">
		  ...
		  <input type="text" class="form-control" autocomplete="off" placeholder="First Name" id="userFirstName">
		</div>
		<div class="form-group">
		  <label for="userLastName">Last Name:</label>
		  <input type="text" class="form-control" autocomplete="off" placeholder="Last Name" id="userLastName">
		</div>
		<div class="form-group">
		  <label for="username">Username:</label>
		  <input type="text" class="form-control" autocomplete="off" placeholder="Username" id="username">
		</div>
		<div class="form-group">
