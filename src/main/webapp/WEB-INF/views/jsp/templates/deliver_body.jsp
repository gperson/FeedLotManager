<div id="content">
	<div class="center_row col-md-12">
		...
		<div class="center_row col-md-12">
			<span id="amount_delivered">Amount</span>			
			<div id="pounds_container" class="input-group">
		      <input id="pounds" type="text" class="form-control" placeholder="Lbs">
		      <span class="input-group-btn">
		        <button class="btn btn-default" type="button">Full</button>
		      </span>
		    </div>
		</div>		
		<div class="center_row col-md-12">
